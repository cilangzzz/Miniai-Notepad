...
<template>
  <div class="categories-page px-6 md:px-12 max-w-7xl mx-auto">
    <!-- Hero Header -->
    <section class="mb-16">
      <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <h2 class="text-5xl md:text-7xl font-black font-headline leading-none tracking-tighter text-white uppercase italic -skew-x-2">
        ...
        <div class="flex gap-4">
          <button
            type="button"
            class="bg-white text-black p-4 font-black font-headline border-4 border-white shadow-neo-gold hover:-translate-y-1 hover:-translate-x-1 transition-all uppercase"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
      ...
      <div class="lg:col-span-5 flex flex-col gap-8">
        ...
        <div class="bg-surface-container-high border-4 border-white p-8 relative">
          <div class="absolute -top-6 -left-2 bg-secondary-container border-2 border-white px-4 py-1 font-headline font-black text-white uppercase">
            Active Categories
          </div>
    ...
    <div class="fixed top-20 right-20 -z-10 pointer-events-none opacity-10 rotate-12 hidden md:block">
